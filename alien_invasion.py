...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        """Create a new bullet and add it to thw bullets group"""
    ...
    def _update_bullets(self):
        """Update position of bullests and get rid of old bullets"""
        self.bullets.update()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Check for any bullets that have hit aliends
...
if __name__ == "__main__":
    # Make a game instace, adn run the game.
    ai = AlienInvasion()
    ai.run_game()
